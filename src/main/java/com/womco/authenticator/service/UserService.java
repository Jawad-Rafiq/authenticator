...
import com.womco.authenticator.controller.dto.*;
import com.womco.authenticator.exception.PasswordException;
...
public class UserService {
    ...
    public SignupResponse insertUserInfo(SignupRequest request){
        ...
        log.info("userId = [] and passworId = [] save successfully", user.getUserId(), password.getPasswordId());
    ...
    public LoginResponse login(LoginRequest request)  {
        ...
        if(password.isPresent() && !checkPassword(request.getPassword(), password.get().getPasswordHash())){
